...
export const ProductCategoryManagementModal = ({ isOpen, onClose }: CategoryManagementModalProps) => {
  ...
  const handleUpdateCategory = async (id: string) => {
    ...
    setIsSubmitting(true);
    const result = await updateProductCategory(id, editingCategoryName);
    if (result.success) {
    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-800 border border-gray-700 rounded-xl w-full max-w-lg flex flex-col max-h-[80vh]">
        ...
        <div className="p-4 border-b border-gray-700 flex justify-between items-center flex-shrink-0">
          <h3 className="text-lg font-medium text-white">Manage Product Categories</h3>
